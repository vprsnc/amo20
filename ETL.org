...
** Transform Contacts
The sames thing about custom fields as for leads
...
** Schema update
For leads, contacts, and companies we need something more advanced, because there are custom fields which are different for each entity.
...
#+begin_src jupyter-python :session localhost :kernel amo20 :tangle yastaff_etl_contacts.py
import json
from extract import Extract
...
*** Orps
#+begin_src jupyter-python :session localhost :kernel amo20 :tangle orps_etl_contacts.py
import json
from extract import Extract
from amo.entities import Contacts
from setup import amo21
...
#+begin_src jupyter-python :session localhost :kernel amo20 :tangle yastaff_etl_companies.py
import json
from extract import Extract
...
*** Orps
#+begin_src jupyter-python :session localhost :kernel amo20 :tangle orps_etl_companies.py
import json
from extract import Extract
from amo.entities import Companies
from setup import amo21
...
/home/analytics/amo20/venv/bin/python yastaff_etl_leads.py
/home/analytics/amo20/venv/bin/python yastaff_etl_calls.py
/home/analytics/amo20/venv/bin/python yastaff_etl_statuses.py
/home/analytics/amo20/venv/bin/python yastaff_etl_users.py
/home/analytics/amo20/venv/bin/python yastaff_etl_pipelines.py
#+end_src
...
#!/home/analytics/amo20/venv/bin/python
cd /home/analytics/amo20/
/home/analytics/amo20/venv/bin/python orps_etl_leads.py
/home/analytics/amo20/venv/bin/python orps_etl_calls.py
/home/analytics/amo20/venv/bin/python orps_etl_statuses.py
/home/analytics/amo20/venv/bin/python orps_etl_users.py
/home/analytics/amo20/venv/bin/python orps_etl_pipelines.py
#+end_src
